//Module arreglado, reemplazar en : node_modules\whatsapp-web.js\src\webCache\LocalWebCache.js
...
class LocalWebCache extends WebCache {
    ...
    async persist(indexHtml) {
        ...
        if (!version) {
            console.warn("⚠️ No se pudo extraer la versión del manifest de WhatsApp Web.");
            return;
        }
